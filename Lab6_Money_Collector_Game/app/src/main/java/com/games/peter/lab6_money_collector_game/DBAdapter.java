...
public class DBAdapter {
	...
	public static final int COL_COINS = 3;
	// [TO_DO_A4]
	// Update the ALL-KEYS string array
	public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_DATE, KEY_SCORE, KEY_COINS};
	...
	public long insertRow(String date, int score, int coins) {
		// [TO_DO_A8]
		...
		initialValues.put(KEY_COINS, coins);
	...
	public boolean updateRow(long rowId, String date, int score, int coins) {
		String where = KEY_ROWID + "=" + rowId;
