...
public class tab_home_lineup_fragment extends Fragment implements tab_Lineup_fragment.LineupListener {
    ViewStub viewStub;
    String team_name;
    ...
    private void setup_formation(ArrayList<Lineup> lineups,View view){
        ...
        if (getActivity().getIntent().hasExtra("home_team_name")){
            ((TextView)inflated.findViewById(R.id.tv_formation_team_name)).setText(getActivity().getIntent().getStringExtra("home_team_name"));
        }
        ArrayList<Player> players = lineups.get(1).getPlayers();
        int player1_row =players.get(0).getRow();
        if (player1_row==1){
            inflated.findViewById(R.id.llout_col_0_row_0).findViewById(R.id.iv_player_image).setBackgroundResource(R.drawable.circle);
        ...
        for (int i=1;i<players.size();i++){
            ...
            if (col==2){
                ...
                inflated1.findViewById(R.id.iv_player_image).setBackgroundResource(R.drawable.circle);
                ...
                String commonId ="llout_col_7_row_"+row ;
                int id= getResources().getIdentifier(commonId, "id", getActivity().getPackageName());
                ViewStub viewStub = inflated.findViewById(id);
                viewStub.setLayoutResource(R.layout.player_on_pitch_layout);
                View inflated1 = viewStub.inflate();
    ...
    public void onChange(ArrayList<Lineup> lineups) {
        setup_formation(lineups,tab_home_lineup_fragment.this.getView());
    }
    //======================================================
    @Override
