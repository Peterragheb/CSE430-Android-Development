...
public class CustomPitchView extends View {
    ...
    //======================================================
    public CustomPitchView(Context context) {
        super(context);

        init(null,context);
    }
    //======================================================
    public CustomPitchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs,context);
    }
    //======================================================
    public CustomPitchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        init(attrs,context);
    }
    //======================================================
    public CustomPitchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//======================================================
    ...
    private void init(@Nullable AttributeSet set,Context context) {
        ...
        no_of_Rects=(int)Math.ceil(SCREEN_SIZE_HEIGHT/100)+1;
        InitRects(no_of_Rects);
        if (set == null)
            return;

        TypedArray ta = getContext().obtainStyledAttributes(set, R.styleable.CustomPitchView);

        mSquareColor_Dark = ta.getColor(R.styleable.CustomPitchView_square_color, getResources().getColor(R.color.pitch_dark_green));
        mSquareColor_Light = ta.getColor(R.styleable.CustomPitchView_square_color, getResources().getColor(R.color.pitch_light_green));
        mSquareSize = ta.getDimensionPixelSize(R.styleable.CustomPitchView_square_size, SCREEN_SIZE_WIDTH);

        mPaintSquare_Dark.setColor(mSquareColor_Dark);
        mPaintSquare_Light.setColor(mSquareColor_Light);
        mPaintSquare_Borders.setColor(ta.getColor(R.styleable.CustomPitchView_square_color, getResources().getColor(R.color.Transparent_white)));
